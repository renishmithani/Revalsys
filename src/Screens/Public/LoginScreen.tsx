...
export default function LoginScreen() {
  ...
  async function onGoogleButtonPress() {
    ...
    if (!idToken) {
      idToken = signInResult.idToken as any;
    }
    if (!idToken) {
